...
function downloadScripts($param1) {
    ...
    if ($ru -and $param1 -eq "cache-spotify") {
        $links2 = "https://raw.githubusercontent.com/xLamday/SpotX/main/scripts/cache/cache_spotify_ru.ps1"
    }
    if (!($ru) -and $param1 -eq "cache-spotify" ) { 
        $links2 = "https://raw.githubusercontent.com/xLamday/SpotX/main/scripts/cache/cache_spotify.ps1"
    }
    
    $web_Url_prev = "https://github.com/mrpond/BlockTheSpot/releases/latest/download/chrome_elf.zip", $links, `
        $links2, "https://raw.githubusercontent.com/xLamday/SpotX/main/scripts/cache/hide_window.vbs", `
        "https://raw.githubusercontent.com/xLamday/SpotX/main/scripts/cache/run_ps.bat"
...
$url = "https://raw.githubusercontent.com/xLamday/SpotX/main/patches/patches.json"
$retries = 0
